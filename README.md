...
一个基于 React + TypeScript + Canvas 的击剑对战游戏，支持单机 AI 对战、局域网联机和在线 P2P 对战。

## 📖 快速导航

- **🚀 [快速开始](./快速开始.md)** - 3 分钟快速上手
- **👶 [新手完整指南](./BEGINNER_GUIDE.md)** - 从零开始的详细教程
- **🌐 [在线对战指南](./在线对战指南.md)** - **网页版也能联机了！** ⭐
- **☁️ [云服务器部署](./RENDER_DEPLOY.md)** - **更稳定的在线对战** ⭐ 新增
- **📡 [发布到网页](./DEPLOY_TO_WEB.md)** - 让游戏在线可玩
- **🎮 [局域网联机说明](./MULTIPLAYER_GUIDE.md)** - 局域网对战详解

> 💡 **新手提示**：如果是第一次使用，建议先看 [快速开始](./快速开始.md)！
>
> 🎉 **新功能**：现在支持 P2P 在线对战，不需要服务器，网页版也能和朋友联机！查看 [在线对战指南](./在线对战指南.md)
...
- 🌐 **四种游戏模式**：
  - **在线对战（P2P）** - 完全免费，网页版可用，全球对战 ⭐
  - **云服务器对战** - 更稳定，支持多人在线 ⭐ 新增
  - **局域网对战** - 同一 WiFi，最低延迟
  - **单机对战** - 和 AI 练习
- 🎨 优雅的水墨风格视觉设计
- 🎵 动态音效系统
...
1. 访问 https://lxc-0813.github.io/cabin_game/
2. 点击 "在线对战"
3. 创建房间或加入朋友的房间

详细说明请查看 [在线对战指南](./在线对战指南.md)

### 云服务器对战 - 最稳定

**比 P2P 更稳定，支持多人同时在线！**

1. 按照 [云服务器部署指南](./RENDER_DEPLOY.md) 部署服务器
2. 访问 https://lxc-0813.github.io/cabin_game/
3. 点击 "局域网对战"
4. 输入你的云服务器地址（如 `https://cabin-game-server-xxxx.onrender.com`）
5. 连接并创建/加入房间
